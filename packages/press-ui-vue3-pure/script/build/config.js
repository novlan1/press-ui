...
const Components = require('../../../press-ui/config/components.json');
const POSTCSS_CONFIG_FILE = path.resolve(__dirname, 'postcss.config.js');

const { LOADER: CROSS_GAME_STYLE_LOADER } = require('@plugin-light/webpack-loader-cross-game-style');
const { LOADER: IF_DEF_LOADER } = require('@plugin-light/webpack-loader-ifdef');
