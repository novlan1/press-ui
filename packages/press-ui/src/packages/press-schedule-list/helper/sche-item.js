...
} from '../../press-schedule-tree/helper/status-helper';
import {
...
function getTreeNodeUniId(nodeItem = {}) {
...
export function parseScheItemData({
  ...
  return {
    ...
    middleButtonTitle: isPreview
      ? ''
      : (MIDDLE_BUTTON_TITLE_MAP[middleButtonStatus] || ''),
    middleButtonClass,
...
export const formatScheItemData = parseScheItemData;
