...
<img 
  src="https://cdn.uwayfly.com/press/img/inner-architecture.png" width="700"
/>
...
<img src="https://cdn.uwayfly.com/article/2024/6/own_mike_bbf5d09066a8980616.gif" width="500" />

### 5.5. 适配多平台、多场景

Press UI 在兼容 Vue3 项目、非 `uni-app` 环境、APP 环境时，采用的实现方式为，新建工程，并将 Press UI 组件库作为子仓库。

<img src="https://cdn.uwayfly.com/article/2024/6/own_mike_ea7bcae60b32baedd8.gif" width="500" />

### 5.6. 通用 & 灵活

下图是 H5、小程序、APP语法灵活度的对比。

<img src="https://cdn.uwayfly.com/article/2024/6/own_mike_fa30be46a942e03072.gif" width="300" />
