...
export default {
  ...
  i18n: {
    'zh-CN': {
      ...
      'quickLink.vue3-uni': 'Vue3 Uniapp 示例',
      'quickLink.vue2-uni': 'Vue2 Uniapp 示例',
      'quickLink.vue3-not-uni': 'Vue3 非 Uniapp 示例',
      'quickLink.vue2-not-uni': 'Vue2 非 Uniapp 示例',
    },
    'en-US': {
      ...
      'quickLink.vue3-uni': 'Vue3 Uniapp Demo',
      'quickLink.vue2-uni': 'Vue2 Uniapp Demo',
      'quickLink.vue3-not-uni': 'Vue3 Not Uniapp Demo',
      'quickLink.vue2-not-uni': 'Vue2 Not Uniapp Demo',
    },
  },
  components: {
    PressDemoIndex,
