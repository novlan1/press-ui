...
const ACT_COMMON_CSS = [
  'https://cdn.uwayfly.com/igame/component/style-reset/reset.css',
];

// 测试链接:  https://cdn.uwayfly.com/2022/a20220408wwkhActivity/css/comm.css
export function loadStyles(urls: Array<string>) {
  loaderUnity('https://cdn.uwayfly.com/igame/common/js/adapter.js', () => {});
