<template>
  <div
    v-if="innerShow"
    class="press-datetime-picker-popup-plus"
  >
    <PressPopupPlus
      ...
      @cancel="cancel"
    >
      <div class="press-datetime-picker-popup-plus__picker">
        <PressDatetimePicker
          ref="picker"
      ...
      <div
        v-if="tip"
        class="press-datetime-picker-popup-plus__tip"
      >
        {{ tip }}
      </div>
    </PressPopupPlus>
...
.press-datetime-picker-popup-plus {
  &__picker {
  }
  &__tip {
  }
