<template>
  <div class="demo-wrap">
    ...
    <demo-block :title="t('avatarGroup')">
      <PressAvatarGroup
        :urls="urls"
...
<script>
import PressAvatar from 'src/packages/press-avatar/press-avatar.vue';
import PressAvatarGroup from 'src/packages/press-avatar-group/press-avatar-group.vue';
