  ...
  const cellList = [
    ...
    },
    {
      ...
      click: ({ context: popupContext }) => {
        ...
        }).then(({ context: popupContext, value }) => {
          popupContext.closeDialog();
        ...
        click: ({ context: popupContext }) => {
          ...
          showBatchSetInnerPopup({
            meta: {
              ...
              timePickerFormatter:
              (type, value, currentDate) => otherOptionDateTimeFormatter({
                type,
                value,
                minDate: DATE_TIME_PICKER_MAX_MIN_DATE.LATEST_READY.MIN,
                currentDate,
              ...
              timePickerFilter:
              (type, options, currentDate) => otherOptionDateTimePickerFilter({
                type,
                options,
                currentDate,
              }),
