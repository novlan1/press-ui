...
export default {
  ...
  data() {
    return {
      ...
      is_color_type: false,
      content: [{
        iconPath: 'https://cdn.uwayfly.com/article/2023/5/own_mike_394e9b73a2b402c417.png',
        selectedIconPath: 'https://cdn.uwayfly.com/article/2023/5/own_mike_ddaf193c855d2d4b93.png',
        text: this.t('image'),
        active: false,
      },
      {
        iconPath: 'https://cdn.uwayfly.com/article/2023/5/own_mike_48f3dce2ae13561480.png',
        selectedIconPath: 'https://cdn.uwayfly.com/article/2023/5/own_mike_119ad562534f721c7f.png',
        text: this.t('home'),
        active: false,
      },
      {
        iconPath: 'https://cdn.uwayfly.com/article/2023/5/own_mike_069e81d6aae9e308e1.png',
        selectedIconPath: 'https://cdn.uwayfly.com/article/2023/5/own_mike_eda1e7d95cb62dc6e1.png',
        text: this.t('star'),
        active: false,
      },
      ],
